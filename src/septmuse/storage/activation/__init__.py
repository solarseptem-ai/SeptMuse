...
"""激活记忆 (KV-Cache) — 平面 B 存储形态之一 (架构文档 §3.1.2/§4)。
...
class ActivationMemory:
    ...
    # ------------------------------------------------------------------
    # CRUD (add/get/get_by_ids/get_all/delete/delete_all)
    # ------------------------------------------------------------------
    ...
    def dump(self, path: str) -> None:
        ...
        # 注册 DynamicCache / KVCacheItem 为 safe globals (安全反序列化)
